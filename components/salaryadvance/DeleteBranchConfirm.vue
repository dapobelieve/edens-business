      ...
      <div class="modal-content" >
        ...
        <div v-if="details" class="modal-body" style="height: 10rem">
            <div class="flex-grow-1 px-2">
                <small class="text-black-50">Are you sure you want to remove <span class="text-jungle-green fw-bold"> {{details.name}} </span> from your branch? Removing this branch deletes it forever.</small>
            </div>
...
export default {
  ...
  methods:{
      submit(){
        this.$emit('delete-branch', this.details)
      }
  },
  components: { Loader }
}
